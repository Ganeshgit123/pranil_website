      <div class="container">
          ...
          <div class="navbar-collapse offcanvas-nav">
              ...
              <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="services.php">Service</a>
                      <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="payroll_compliance_activities.php"> Payroll & Compliance activities
                              </a></li>
                          <li><a class="dropdown-item" href="payroll_process_automation.php"> Payroll Process Automation
                              </a></li>
